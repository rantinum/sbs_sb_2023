  ...
  <div class="container mx-auto px-3">
    <div class="flex">
      ...
      <form>
        ...
        <select name="searchKeywordTypeCode" id="" class="select select-bordered" data-value="${param.searchKeywordTypeCode}">
          <option disabled="disabled">검색타입</option>
          <option value="title">제목</option>
          <option value="body">내용</option>
          <option value="title,body">제목, 내용</option>
        </select>
        <input type="text" name="searchKeyword" class="input input-bordered ml-2 w-72" placeholder="검색어" maxlength="25" value="${param.searchKeyword}"/>
