      ...
      <colgroup>
        ...
        <tbody>
          <tr>
            ...
            <label>
              공지
              <input type="radio" value="1" name="boardId" />
            </label>
            <label>
              자유
              <input type="radio" value="2" name="boardId"/>
            </label>
            </td>
             -->
          </tr>
          ...
          <tr>
            <th>제목</th>
            <td>
              <input required="required" type="text" class="input input-bordered w-full max-w-xs" name="title" placeholder="제목"/>
            </td>
          </tr>
          <tr>
            <th>내용</th>
